...
/**
 * This is used to provide some context to {@link LuaMethod}s, i.e. the
...
public interface Context {
     ...
     * <p/>
     * As computers control the behaviour of the bame, only a small list of users
     * (generally server operators) should be able to access the computer.
     * This access includes:
     * <ul>
     * <li>Trigger input via a keyboard.</li>
     * <li>Start, shutdown, or reboot the computer.</li>
     * </ul>
     * <p/>
