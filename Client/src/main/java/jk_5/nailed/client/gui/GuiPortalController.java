    ...
    protected void func_146284_a(GuiButton button) {
        if(button.field_146125_m){
            if(button.field_146127_k == 1){
                ...
                ClientNetworkHandler.sendPacketToServer(new NailedPacket.GuiReturnDataPacket(this.portalController.field_145851_c, this.portalController.field_145848_d, this.portalController.field_145849_e, data));
