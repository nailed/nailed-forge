...
@NoArgsConstructor
@AllArgsConstructor
public class InstructionEnableStat implements IInstruction {
    ...
    public IInstruction cloneInstruction() {
        return new InstructionEnableStat(this.stat);
    }

    @Override
    public void execute(GameController controller) {
        controller.getMap().getStatManager().getStat(this.stat);//.enable();
    }
}
