package jk_5.nailed.teamspeak.api.de.stefan1200.jts3serverqueryexample;
...
public class JTS3ServerQueryExample implements TeamspeakActionListener
{
	...
	void runServerMod()
	{
		...
		if (!query.connectTS3Query("192.168.178.20", 10011))
		{
			echoError();
			return;
		}
		...
		query.loginTS3("serveradmin", System.getProperty("ts3password"));
